...
const Balance = () => {
    ...
    const tokenBlances = useSelector(state => state.tokens.balances);
    const exchangeBlances = useSelector(state => state.exchange.balances);
    ...
    return (
      <div className='component exchange__transfers'>
        ...
        {/* Deposit/Withdraw Component 1 (NRJ) */}
  
        <div className='exchange__transfers--form'>
          <div className='flex-between'>
            <p><small>Token</small><br /><img src={dapp} alt="Token Logo" />{symbols && symbols[0]}</p>
            <p><small>Wallet</small><br />{tokenBlances && tokenBlances[0]}</p>
            <p><small>Exchange</small><br />{exchangeBlances && exchangeBlances[0]}</p>
          </div>
        ...
        <div className='exchange__transfers--form'>
          <div className='flex-between'>
            ...
            <p><small>Wallet</small><br />{tokenBlances && tokenBlances[1]}</p>
            <p><small>Exchange</small><br />{exchangeBlances && exchangeBlances[1]}</p>
          </div>
